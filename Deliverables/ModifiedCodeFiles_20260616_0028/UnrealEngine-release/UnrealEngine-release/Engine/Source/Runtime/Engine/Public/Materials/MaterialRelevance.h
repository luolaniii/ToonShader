...
struct FMaterialRelevance
{
	...
	// NOTE: MSM_Toon (=13) occupies the last available bit; widening past 14 shading models
	// requires growing ShadingModelMask and shrinking another field in this 32-bit block.
	union
	{
		struct
		{
	...
	{
		const uint32 LocalSubstrateUintPerPixel = SubstrateUintPerPixel;
		Raw |= B.Raw;
