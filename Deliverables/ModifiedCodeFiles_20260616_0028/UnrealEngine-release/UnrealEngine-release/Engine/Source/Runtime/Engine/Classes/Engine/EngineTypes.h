...
enum EMaterialShadingModel : int
{
	...
	/** Toon shading model: two-band cel shading with controllable shadow color (uses GBuffer CustomData). */
...
static_assert(MSM_NUM <= 14, "FMaterialRelevance::ShadingModelMask only has 14 bits (MSM_Toon uses the last one) - widen it before adding more shading models!");
