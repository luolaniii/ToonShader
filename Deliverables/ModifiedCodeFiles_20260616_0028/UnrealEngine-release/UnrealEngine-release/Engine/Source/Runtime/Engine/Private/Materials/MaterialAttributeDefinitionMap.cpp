...
FText FMaterialAttributeDefinitionMap::GetAttributeOverrideForMaterial(const FGuid& AttributeID, UMaterial* Material)
{
	...
	case MP_Metallic:
		...
		CustomPinNames.Add({ MSM_Toon, LOCTEXT("ShadowSoftness", "Shadow Softness").ToString()});
	...
	case MP_SubsurfaceColor:
		...
		CustomPinNames.Add({ MSM_Toon, LOCTEXT("ToonShadowColor", "Shadow Color").ToString() });
	...
	case MP_CustomData0:
		...
		CustomPinNames.Add({ MSM_Toon, LOCTEXT("ToonShadowThreshold", "Shadow Threshold").ToString() });
